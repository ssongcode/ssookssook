...
import com.ssafy.ssuk.plant.dto.TotalInfoResponseDto;
import com.ssafy.ssuk.plant.dto.TotalPlantResponseDto;
...
public class CategoryQueryRepositoryImpl implements CategoryQueryRepository {
    ...
    private List<TotalCategoryResponseDto> findCategories() {
        return em.createQuery("select new com.ssafy.ssuk.plant.dto.TotalCategoryResponseDto(pc.id, pc.name) from Category pc"
                , TotalCategoryResponseDto.class).getResultList();
    }

    private List<TotalPlantResponseDto> findPlants() {
        return em.createQuery("select new com.ssafy.ssuk.plant.dto.TotalPlantResponseDto(pc.id, p.id, p.name, p.tempMax, p.tempMin, p.moistureMax, p.moistureMin)" +
                        " from Plant p" +
    ...
    private List<TotalInfoResponseDto> findInfos() {
        return em.createQuery("select new com.ssafy.ssuk.plant.dto.TotalInfoResponseDto(" +
