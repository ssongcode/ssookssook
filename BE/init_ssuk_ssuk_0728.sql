...
--
-- Host: 127.0.0.1    Database: ssuk_ssuk
-- ------------------------------------------------------
...
CREATE TABLE `collection` (
  ...
  PRIMARY KEY (`collection_id`,`user_id`,`level`,`plant_id`),
  KEY `FK_user_TO_collection_1` (`user_id`),
  KEY `FK_plant_info_TO_collection_2` (`plant_id`),
  KEY `FK_plant_info_TO_collection_1` (`level`),
  CONSTRAINT `FK_plant_info_TO_collection_1` FOREIGN KEY (`level`) REFERENCES `plant_info` (`level`),
  CONSTRAINT `FK_plant_info_TO_collection_2` FOREIGN KEY (`plant_id`) REFERENCES `plant_info` (`plant_id`),
...
CREATE TABLE `garden` (
  ...
  PRIMARY KEY (`garden_id`,`plant_id`,`user_id`,`pot_id`,`category_id`),
  KEY `FK_plant_TO_garden_1` (`plant_id`),
  KEY `FK_plant_TO_garden_2` (`category_id`),
  KEY `FK_user_TO_garden_1` (`user_id`),
  KEY `FK_pot_TO_garden_1` (`pot_id`),
  CONSTRAINT `FK_plant_TO_garden_1` FOREIGN KEY (`plant_id`) REFERENCES `plant` (`plant_id`),
  CONSTRAINT `FK_plant_TO_garden_2` FOREIGN KEY (`category_id`) REFERENCES `plant` (`category_id`),
...
CREATE TABLE `notification` (
  ...
  PRIMARY KEY (`notification_id`,`user_id`,`pot_plant_id`,`pot_id`),
  KEY `FK_user_TO_notification_1` (`user_id`),
  KEY `FK_garden_TO_notification_1` (`pot_plant_id`),
  KEY `FK_garden_TO_notification_2` (`pot_id`),
  KEY `FK_garden_TO_notification_3` (`category_id`),
  CONSTRAINT `FK_garden_TO_notification_1` FOREIGN KEY (`pot_plant_id`) REFERENCES `garden` (`garden_id`),
  CONSTRAINT `FK_garden_TO_notification_2` FOREIGN KEY (`pot_id`) REFERENCES `garden` (`pot_id`),
  CONSTRAINT `FK_garden_TO_notification_3` FOREIGN KEY (`category_id`) REFERENCES `garden` (`category_id`),
...
CREATE TABLE `plant_info` (
  ...
  PRIMARY KEY (`level`,`plant_id`),
  KEY `FK_plant_TO_plant_info_1` (`plant_id`),
...
CREATE TABLE `user_badge` (
  ...
  PRIMARY KEY (`user_badge_id`,`user_id`,`badge_id`),
...
-- Dump completed on 2023-07-28 21:48:35
